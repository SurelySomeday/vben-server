package top.yxlgx.common.security.config.token.impl;
...
public class OAuth2TokenSettingsImpl implements OAuth2TokenSettings {
	...
	public OAuth2TokenSettingsImpl(@Value("${oauth2.access.token.time:6}") long accessTokenTime,
			@Value("${oauth2.access.token.time.unit:HOUR}") String accessTokenTimeUnit,
			@Value("${oauth2.refresh.token.time:6}") long refreshTokenTime,
			@Value("${oauth2.refresh.token.time.unit:HOUR}") String refreshTokenTimeUnit) {
