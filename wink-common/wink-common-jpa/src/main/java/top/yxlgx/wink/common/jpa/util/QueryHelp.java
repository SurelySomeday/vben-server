 ...
 */
package top.yxlgx.wink.common.jpa.util;
...
public class QueryHelp {
    ...
    public static <R, Q> Predicate getPredicate(Root<R> root, Q query,CriteriaQuery<?> criteriaQuery, CriteriaBuilder cb) {
        ...
        try {
            ...
            for (Field field : fields) {
                ...
                if (q != null) {
                    ...
                    if (ObjectUtils.anyNull(val) || "".equals(val)) {
                        continue;
                    }
                    Join join = null;
                    // 模糊多字段
                    ...
                    if (ObjectUtils.isNotEmpty(joinName)) {
                        ...
                        for (String name : joinNames) {
                            switch (q.join()) {
                                case LEFT:
                                    if(ObjectUtils.allNotNull(join) && ObjectUtils.allNotNull(val)){
                    ...
                    switch (q.type()) {
                        ...
                        case RIGHT_LIKE:
                            ...
                            break;
                        case IN:
                            if (CollectionUtil.isNotEmpty((Collection<Object>)val)) {
